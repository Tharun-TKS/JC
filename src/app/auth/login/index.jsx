...
export default class Login extends Component {
    ...
    if (formValid(this.state) && this.state.activeTab === "login") {
      ...
      if (user) {
        ...
        NotificationManager.error(
          "Please check your email or phone & password",
          "Input Error"
        );
      }
    } else if (this.state.activeTab === "login") {
  ...
  render() {
    let { emailOrPhone, password, formErrors, activeTab, showPassword } =
      this.state;
    return (
      <div>
        <div className="modal fade login-modal-main" id="bd-example-modal">
                          ...
                          <div className="tab-content">
                            ...
                            >
                              ...
                              <div className="custom-control custom-checkbox">
                                ...
                                <a
                                  onClick={() =>
                                    this.handleTabChange("forgotpassword")
                                  }
                            ...
                            <div
                              ...
                              role="tabpanel"
                            >
                             <Register onRegisterSuccess={() => this.handleTabChange("login")} />
                            </div>
                            <div
                              className={`tab-pane ${
